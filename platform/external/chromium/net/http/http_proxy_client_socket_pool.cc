...
// SAMSUNG CHANGE : change connection timeout 30 to 6 for not delaying user experience. final timeout value is 21 sec because timeout value of transport socket is 15 sec.
//static const int kHttpProxyConnectJobTimeoutInSeconds = 30;
static const int kHttpProxyConnectJobTimeoutInSeconds = 6;
// SAMSUNG CHANGE
